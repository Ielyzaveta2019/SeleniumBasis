...
//			Thread.sleep(2000);
			...
			js.executeScript("arguments[0].scrollIntoView(true);", label);//it will scroll down 
			//to the element that i wanna see
			
			
			
			//or click on QTP
			List<WebElement> toolsChbx=driver.findElements(By.name("tool"));
			for (WebElement chbox: toolsChbx) {//toolsChbox thats where we wanna click
				if (chbox.isEnabled()) {
